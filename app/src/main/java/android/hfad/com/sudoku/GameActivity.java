...
public class GameActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        wannaBack = true;
        Toast.makeText(this, "'click again for go to back screen", Toast.LENGTH_SHORT).show();
...
//        dialog.setMessage(message).setTitle("Instruct").show();
//    }
    ...
    public void onClickSubmit(View view) {
        ...
        if (solver.checkValidGrid(grid.getNumbers())) {
            Toast.makeText(this, "Congratulations, the correct answer", LENGTH_LONG).show();
            status = 0;
            if (status >= 0) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(this, R.style.Theme_AppCompat_Light_Dialog);
