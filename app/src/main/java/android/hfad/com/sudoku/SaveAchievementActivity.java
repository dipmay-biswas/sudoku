...
public class SaveAchievementActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Save the result");
        ...
        txtDifficulty.setText(String.format("%-15s %s", "Level of difficult:", GameActivity.DIFFICULT_NAME[difficulty]));
        txtDifficulty.setTypeface(AppConstant.APP_FONT);

        txtTimeElapsed = findViewById(R.id.txtTimeElapsed);
        txtTimeElapsed.setText(String.format("%-15s %s", "Time:", Timer.getTimeFormat(elapsedSeconds)));
    ...
    public void onClickOK(View view) {
        ...
        if(nickname.length() > 0) {
            ...
            Toast.makeText(this, "Nickname cannot be left blank", Toast.LENGTH_LONG).show();
        }
    }
}
